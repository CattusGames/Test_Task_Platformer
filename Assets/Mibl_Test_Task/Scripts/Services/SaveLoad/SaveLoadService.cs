...
namespace Services.SaveLoad
{
    public class SaveLoadService : ISaveLoadService
    {
        ...
        public void SaveProgress() => 
            PlayerPrefs.SetString(PlayerProgressKey, _progress.Player.ToJson());

        public PlayerData LoadProgress() => PlayerPrefs.GetString(PlayerProgressKey)?.ToDeserialize<PlayerData>(); 
